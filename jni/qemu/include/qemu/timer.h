...
//XXX: Using a monotonically increased value (as below) doesn't work
// conventiently we can get a good value from the clock
// there should be another way to do it on ARM (assembly)
static inline int64_t cpu_get_real_ticks(void)
{
	return get_clock();
